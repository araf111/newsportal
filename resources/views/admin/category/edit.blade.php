                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="name_english" id="name_english" value="{{$category->name_english}}" class="form-control flat-input" placeholder="{{__('Name')}}">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input__group mb-25">
                                        ...
                                        <select class="form-control" name="parent_id">
                                            ...
                                            <option value="{{ $eachCat->id }}" {{$eachCat->id == $category->parent_id ? 'selected':''}}>
                                                {{ $eachCat->name}}
                                            </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="meta_title" value="{{$category->meta_title}}" placeholder="{{ __('Meta title') }}" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="meta_description" value="{{$category->meta_description}}" placeholder="{{ __('meta description') }}" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="meta_keywords" value="{{$category->meta_keywords}}" placeholder="{{ __('meta keywords') }}" class="form-control">
